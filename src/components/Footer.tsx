        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-20">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex gap-4 mt-2">
              <a href="https://www.facebook.com/share/1b2Fk7oC9q/ 2" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-white/40 hover:bg-bhutan-red hover:text-white transition-all border border-white/10 uppercase font-bold text-[10px]">
                <Facebook className="w-4 h-4" />
              </a>
              <a href="https://tiktok.com/@phojaa95realestate" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-white/40 hover:bg-bhutan-red hover:text-white transition-all border border-white/10 uppercase font-bold text-[10px]">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-6">
              <li className="flex gap-4 items-start">
                ...
                <span className="text-white/50 text-sm leading-relaxed">Norzin Lam, Thimphu, Bhutan</span>
              </li>
              <li className="flex gap-4 items-start">
                <Phone className="w-5 h-5 text-bhutan-red flex-shrink-0" />
                <span className="text-white/50 text-sm leading-relaxed">+975 16111999</span>
              </li>
              <li className="flex gap-4 items-start">
                <Mail className="w-5 h-5 text-bhutan-red flex-shrink-0" />
                <span className="text-white/50 text-sm leading-relaxed">phojaa95realestate@gmail.com</span>
              </li>
            </ul>
          </div>
        </div>
