...
const priorities = [
    { value: "low", label: "Low", color: "bg-ink-100 text-ink-500" },
    { value: "normal", label: "Normal", color: "bg-sky/10 text-sky" },
...
export default function NewAnnouncementPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (data.success) {
                toast({ title: "Success", description: formData.isPublished ? "Announcement published!" : "Draft saved." });
