      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          ...
          <motion.div
            ...
            key={stat.label}
            className="bg-card p-6 rounded-[20px] shadow-soft border border-ink-100/60 flex items-center justify-between"
          >
            <div>
              <p className="text-[11px] sm:text-[13px] sm:text-[13px] font-semibold text-ink-400 uppercase tracking-wider mb-1">{stat.label}</p>
              <p className="text-3xl font-semibold text-foreground">{stat.value}</p>
            </div>
            <div className={cn("w-12 h-12 rounded-2xl flex items-center justify-center", stat.bgClass)}>
              <stat.icon className={cn("w-6 h-6", stat.iconClass)} strokeWidth={1.5} />
            </div>
          </motion.div>
        ))}
      </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-muted border-b border-ink-100/60">
              <tr>
                <th className="px-8 py-5 text-left text-[11px] sm:text-[13px] sm:text-[13px] font-semibold text-ink-400 uppercase tracking-wider">Contact</th>
                <th className="px-8 py-5 text-left text-[11px] sm:text-[13px] sm:text-[13px] font-semibold text-ink-400 uppercase tracking-wider">Subject & Message</th>
                <th className="px-8 py-5 text-left text-[11px] sm:text-[13px] sm:text-[13px] font-semibold text-ink-400 uppercase tracking-wider">Date</th>
                <th className="px-8 py-5 text-left text-[11px] sm:text-[13px] sm:text-[13px] font-semibold text-ink-400 uppercase tracking-wider">Status</th>
                <th className="px-8 py-5 text-right text-[11px] sm:text-[13px] sm:text-[13px] font-semibold text-ink-400 uppercase tracking-wider">Actions</th>
              </tr>
            </thead>
                  ...
                  <tr>
                    <td colSpan={5} className="px-8 py-20 text-center">
                      <div className="flex flex-col items-center gap-4">
                        ...
                        <p className="text-ink-400 text-xl font-light">No inquiries found matching your search.</p>
                      </div>
                    </td>
                  </tr>
                ) : (
                    ...
                    >
                      <td className="px-8 py-6">
                        <div className="flex items-center gap-4">
                          <div className={cn(
                            "w-12 h-12 rounded-2xl flex items-center justify-center text-lg font-semibold shadow-sm transition-all duration-500",
                            !inquiry.isRead
                          ...
                          <div>
                            <h4 className={cn("font-semibold text-base tracking-tight", inquiry.isRead ? "text-ink-700" : "text-foreground")}>
                              {inquiry.name}
                            </h4>
                            <div className="flex items-center gap-2 text-[11px] sm:text-[13px] sm:text-[13px] font-medium uppercase tracking-wider text-ink-400">
                      ...
                      <td className="px-8 py-6">
                        <div className="flex flex-col text-[11px] sm:text-[13px] sm:text-[13px] font-medium uppercase tracking-wider text-ink-400">
                      ...
                      <td className="px-8 py-6">
                        {inquiry.isRead ? (
                          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-600 text-[11px] sm:text-[13px] sm:text-[12px] font-semibold uppercase tracking-wider border border-emerald-500/20">
                            <CheckCircle2 className="w-3 h-3" strokeWidth={1.5} />
                            Responded
                          </span>
                        ) : (
                          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-orange-500/10 text-orange-600 text-[11px] sm:text-[13px] sm:text-[12px] font-semibold uppercase tracking-wider border border-orange-500/20 animate-pulse">
                      ...
                      <td className="px-8 py-6 text-right">
                        <div className="flex items-center justify-end gap-2">
                          <Link
                            ...
                            className="w-10 h-10 rounded-xl flex items-center justify-center bg-muted text-ink-400 hover:bg-sky hover:text-background transition-all duration-300 shadow-sm"
                          >
                            <ChevronRight className="w-5 h-5" strokeWidth={1.5} />
                          </Link>
                          <button
                            onClick={() => handleDelete(inquiry._id)}
                            className="w-10 h-10 rounded-xl flex items-center justify-center bg-red-500/10 text-red-400 hover:bg-red-500 hover:text-background transition-all duration-300 shadow-sm"
