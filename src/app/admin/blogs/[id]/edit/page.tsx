            ...
            <header className="mb-7 flex items-center gap-4">
                ...
                <div>
                    <div className="flex items-center gap-2 mb-0.5">
                        ...
                        <p className="text-bhutan-red font-bold text-xs uppercase tracking-[0.3em]">Edit Post</p>
                    </div>
                    <h1 className="text-3xl font-bold text-bhutan-dark">Modify Blog</h1>
                </div>
            </header>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-2xl p-5 border border-bhutan-gold/10 shadow-sm">
                            ...
                            <div className="space-y-4">
                                ...
                                <label className="flex items-center gap-3 p-3 bg-[#F9F7F2] rounded-xl cursor-pointer hover:bg-bhutan-gold/5 transition-colors border border-transparent hover:border-bhutan-gold/20">
                                    ...
                                    />
                                    <div>
                                        <span className="text-sm font-bold text-bhutan-dark uppercase tracking-widest">Published</span>
                                        <p className="text-xs text-bhutan-dark/40">Visible on frontend</p>
                                    </div>
                                </label>
                            </div>
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            >
                                {isSubmitting ? <><Loader2 className="w-4 h-4 animate-spin" /> Saving...</> : "Update Blog"}
                            </button>
                        </div>
                    </div>
                </div>
