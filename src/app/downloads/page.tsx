            ...
            <section className="py-20 bg-[#F9F7F2]">
                <div className="container-luxury mx-auto px-6">
                    ...
                    <div className="max-w-4xl mx-auto -mt-32 mb-16 relative z-20">
                        <div className="bg-white p-2 rounded-2xl shadow-xl border border-bhutan-gold/10 flex items-center">
                            <div className="relative flex-1">
                                <Search className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 w-5 h-5" />
                                <input
                                    type="text"
                                    placeholder="Search documents by name or keyword..."
                                    className="w-full pl-12 pr-6 py-4 bg-transparent border-none focus:ring-0 text-bhutan-dark font-medium"
                                    value={searchQuery}
                    ...
                    {loading ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {filteredDocs.map((doc, i) => (
                                <motion.div
                                    ...
                                    key={doc._id}
                                    className="bg-white rounded-[2rem] p-8 border border-gray-100 shadow-soft hover:shadow-xl transition-all group flex flex-col h-full"
                                >
                                    <div className="flex items-center justify-between mb-6">
                                        ...
                                        <div className="bg-bhutan-gold/10 text-bhutan-gold text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-tighter">
                                            {doc.fileSize}
                                        </div>
                                    </div>

                                    <h3 className="text-xl font-bold text-bhutan-dark mb-3 group-hover:text-bhutan-red transition-colors flex-grow">
                                        {doc.title}
                                    </h3>
                                    ...
                                    <div className="mt-auto space-y-6">
                                        <div className="flex items-center gap-4 text-[10px] font-bold uppercase tracking-[0.2em] text-gray-400 border-t border-gray-50 pt-6">
                        ...
                        <div className="text-center py-32 bg-white rounded-[3rem] border border-bhutan-gold/10 shadow-sm overflow-hidden relative">
                            ...
                            <h3 className="text-2xl font-bold text-bhutan-dark mb-3">No documents available</h3>
